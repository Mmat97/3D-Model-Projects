...
//My Part 2 Functions
char shifting(int length, int n, char letter,char** argv);
void encryption(FILE *in, FILE *out, char** argv, int argc);
void decryption(FILE *in, FILE *out, char** argv, int argc);
void tutneseE(FILE *in, FILE *out, char** argv, int argc);
